...
addon.Options = { type = "group", name = "DragonUI-CF", args = {} }
...
function addon.core:OnEnable()
    ...
    if addon.Print then
        addon:Print("DragonUI-CF loaded, Updated by MrKrisSatan for Grimfall WoW")
    else
        print("|cFF00FF00[DragonUI-CF]|r DragonUI-CF loaded, Updated by MrKrisSatan for Grimfall WoW")
    end
