...
local function BuildGeneralTab(scroll)
    ...
    C:AddLabel(about, "|cff1784d1DragonUI-CF v3.6.8|r")
    C:AddDescription(about, "DragonUI-CF for Grimfall WoW 3.3.5a with embedded ClassForge, XToLevel, and Cromulent support.")
    C:AddSpacer(about)
    C:AddDescription(about, "Updated by MrKrisSatan for Grimfall WoW")
    C:AddSpacer(about)
    ...
    C:AddCopyableText(about, "https://github.com/MrKrisSatan/DragonUI-CF")
